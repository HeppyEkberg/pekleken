...
@section('content')
    ...
    <div id="wrapper">
        <div id="content">
            <iframe style="width: 100%; min-height: 400px" src="https://www.youtube.com/embed/9m7tPikH0UA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
    </div>
    <br><br>
